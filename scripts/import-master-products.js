/**
 * Script para importar produtos Rennova do CSV para master_products
 * Uso: node scripts/import-master-products.js
 */
...
async function importProducts() {
  ...
  try {
    ...
    console.log(`   ✅ ${existingProducts.size} produtos removidos\n`);

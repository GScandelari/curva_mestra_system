...
- Commits da correção: `b08fdeb` (preserva claims reais na desativação), `dbf128f` (reconecta "Suspender" à rota `DELETE`), `d167883` (restaura acesso/claims na reativação), `3ab00b6` (filtro "Suspensos" passa a incluir `'inactive'`), `001671b` (enfileira aviso de troca de e-mail, RN-03)

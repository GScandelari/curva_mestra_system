...
- `src/app/api/tenants/[id]/consultant/route.ts` (GET/POST/DELETE; `POST`/`DELETE` alterados pelo commit `001671b` — sincronização de claims via `syncConsultantAuthorizedTenants`, RN-03)

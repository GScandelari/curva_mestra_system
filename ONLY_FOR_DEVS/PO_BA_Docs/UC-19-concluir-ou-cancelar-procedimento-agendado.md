...
- **UC-52 (Expansão de Relatórios Gerenciais, reservado)** herdará o painel de "histórico de uso por lote" originalmente cogitado para um UC-51 próprio ("Módulo Procedimentos") — não implementado aqui.

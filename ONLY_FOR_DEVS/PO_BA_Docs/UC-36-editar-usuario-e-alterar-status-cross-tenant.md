...
- **UC-22 (Editar, Desativar e Reativar Clínica)** e **UC-29 (Editar, Suspender e Reativar Consultor)** — mesma família de achados original (mecanismo de status "cosmético"). Este UC-36 foi o primeiro dos três a ser corrigido com uma rota dedicada que sincroniza claims e desabilita a conta de fato (`PUT /api/users/[id]`); UC-22 e UC-29 permanecem com o comportamento cosmético documentado em suas respectivas versões, sem correção equivalente confirmada até o momento.

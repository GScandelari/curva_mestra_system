...
exports.isValidDate = exports.isValidPhone = exports.isValidEmail = exports.sanitizeInput = exports.stockAdjustmentSchema = exports.invoiceSchema = exports.requestSchema = exports.patientSchema = exports.productSchema = exports.validateSchema = void 0;
...
const validateSchema = (data, schema) => {
    ...
    if (errors.length > 0) {
        throw new https_1.HttpsError('invalid-argument', `Dados inválidos: ${errors.join(', ')}`);
    }
};
    ...
    products: {
        ...
        custom: (products) => {
            if (!Array.isArray(products))
                return 'Produtos deve ser uma lista';

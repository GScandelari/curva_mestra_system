...
describe('Firestore Security Rules - Basic Tests', () => {
    ...
    describe('Data Structure Validation', () => {
        test('should validate clinic-based data structure', async () => {
            ...
            expect((_a = doc.data()) === null || _a === void 0 ? void 0 : _a.clinicId).toBe(testData.clinicId);
        });
    ...
    describe('Data Validation Rules', () => {
        test('should validate required fields in products', async () => {
            ...
            // This should succeed
            await expect(db.doc(`clinics/${testData.clinicId}/products/valid-product`).set(validProduct)).resolves.not.toThrow();
        ...
        test('should validate data types', async () => {
            ...
            await expect(db.doc(`clinics/${testData.clinicId}/products/typed-product`).set(validProduct)).resolves.not.toThrow();
        });
    });
...
//# sourceMappingURL=security-rules-simple.test.js.map
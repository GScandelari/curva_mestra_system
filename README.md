...
- 🗂️ **7 decisões de produto pendentes** (o item de infraestrutura `ADR-QA-AUTOMATION` foi implementado de ponta a ponta em 17/08/2026, ver Seção 6 do mapa; `UC-35-Decisão` removida em 22/09/2026 por já estar resolvida desde 24/07/2026) e **16 itens de código morto/rotas órfãs** catalogados sem severidade atribuída (ver Seções 4 e 5 do mapa)

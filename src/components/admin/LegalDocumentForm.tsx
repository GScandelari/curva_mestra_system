...
const EMPTY_FORM: Partial<LegalDocument> = {
  title: '',
  slug: '',
  content: '',
  version: '1.0',
...
export function LegalDocumentForm({ mode, documentId }: LegalDocumentFormProps) {
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold">
            {mode === 'create' ? 'Novo Documento Legal' : 'Editar Documento Legal'}
          </h1>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {mode === 'create' ? 'Preencha' : 'Edite'} os dados do documento legal
          </CardDescription>
        </CardHeader>
        ...
        <Button onClick={handleSave} disabled={saving}>
          {saving ? (
            ...
            <>
              ...
              {mode === 'create' ? 'Salvar Documento' : 'Salvar Alterações'}
            </>
          )}
        </Button>
      </div>

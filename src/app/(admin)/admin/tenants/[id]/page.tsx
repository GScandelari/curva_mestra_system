    ...
    return (
      <div className="container py-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/admin/tenants')}>Voltar para Clínicas</Button>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-6">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Consultor responsável por esta clínica</CardDescription>
                </div>
                {tenant.consultant_id && (
                  <Button variant="outline" size="sm" onClick={() => setShowConsultantDialog(true)}>
                    Alterar
                  </Button>
                )}
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Atualize os dados da clínica conforme necessário</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <UserCheck
                            className={`h-5 w-5 ${isActive ? 'text-sky-600' : 'text-gray-400'}`}
                          />
                        </div>
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            <span
                              className={`font-mono font-bold ${isActive ? 'text-sky-600' : 'text-gray-400'}`}
                            >
                              {consultant.code}
                            </span>
                            <span>•</span>

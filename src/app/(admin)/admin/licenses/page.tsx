      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Gerencie as licenças de todas as clínicas</p>
          </div>
                ...
                {licenses.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="px-6 py-12 text-center">
                      ...
                      <Button onClick={() => router.push('/admin/licenses/new')} className="mt-4">
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={getStatusBadge(license.status)}>{license.status}</span>
                          </div>
                        </td>

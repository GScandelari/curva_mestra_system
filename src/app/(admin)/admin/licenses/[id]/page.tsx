...
export default function LicenseDetailsPage() {
  ...
  async function handleRenew() {
    ...
    const months = confirm('Renovar por quantos meses?\n\n6 - Semestral\n12 - Anual');
    if (!months) return;
    ...
    <div className="container py-8">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Detalhes da Licença</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{license.auto_renew ? 'Sim' : 'Não'}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{formatDate(license.start_date)}</p>
            </div>

            <div>
              <p className="text-sm text-gray-600">Data de Término</p>
              <p className="font-medium text-gray-900">{formatDate(license.end_date)}</p>
            </div>

            <div>
              <p className="text-sm text-gray-600">Criada em</p>
              <p className="font-medium text-gray-900">{formatDate(license.created_at)}</p>
            </div>

            <div>
              <p className="text-sm text-gray-600">Última Atualização</p>
              <p className="font-medium text-gray-900">{formatDate(license.updated_at)}</p>
            </div>
          </div>

...
import { CheckCircle, XCircle, Clock, UserPlus, Building2, AlertTriangle } from 'lucide-react';
import {
  listAccessRequests,
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Gerencie pedidos de novos usuários</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Aprove ou rejeite solicitações de acesso</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

      ...
      <div className="flex items-center justify-center">
        <Card className="w-full max-w-2xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl">Parabéns! Sua conta está ativa!</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            {plan && (
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Sua assinatura está ativa e você tem acesso completo a todas as funcionalidades da
                  plataforma.
                </p>
              </div>
            )}
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-white border rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Adicione produtos ao seu catálogo e comece a gerenciar seu inventário
                    </p>
                  </div>
                </div>
            ...
            <div className="text-center pt-4 border-t">
              <p className="text-sm text-muted-foreground mb-2">Precisa de ajuda para começar?</p>

...
import { completePlanSelection, getTenantOnboarding } from '@/lib/services/tenantOnboardingService';
...
export default function PlanSelectionPage() {
  ...
  const [selectedPlan, setSelectedPlan] = useState<'semestral' | 'anual' | null>(null);
      ...
      <div className="flex items-center justify-center">
        <div className="w-full max-w-5xl">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Selecione o melhor plano para sua clínica</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <Card
              className={`relative cursor-pointer transition-all hover:shadow-lg ${
                selectedPlan === 'semestral' ? 'ring-2 ring-primary shadow-lg' : ''
              }`}
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-bold">R$ {semestralPlan.price.toFixed(2)}</span>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-bold">R$ {anualPlan.price.toFixed(2)}</span>
                    <span className="text-muted-foreground">/mês</span>
                  </div>
                  <p className="text-sm text-muted-foreground mt-1">
                  ...
                  <p className="text-sm text-green-600 font-medium mt-1">
                    Você economiza R$ {(semestralTotal * 2 - anualTotal).toFixed(2)} por ano!
                  </p>
                </div>

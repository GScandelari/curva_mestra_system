...
import { CheckCircle, XCircle, Clock, UserPlus, AlertTriangle } from 'lucide-react';
import {
  listAccessRequests,
  ...
  async function handleApprove(request: AccessRequest) {
    ...
    if (limits.available_slots <= 0) {
      toast({
        ...
        description: 'Sua clínica atingiu o limite de usuários. Entre em contato com o suporte.',
        variant: 'destructive',
      });
      return;
    }
    ...
    <div className="container py-8">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Solicitações de Acesso</h2>
            <p className="text-muted-foreground">Pedidos para entrar na sua clínica</p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{limits?.available_slots || 0}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{limits?.current_users || 0}</div>
            </CardContent>
          </Card>
        </div>
        ...
        {limits && limits.available_slots <= 0 && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Sua clínica atingiu o limite de {limits.max_users} usuários. Entre em contato com o
              suporte para aumentar o limite.
            </AlertDescription>
          </Alert>
        )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Aprove ou rejeite solicitações de novos usuários</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (

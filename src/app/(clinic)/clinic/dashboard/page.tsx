    ...
    <div className="container py-8">
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Visão geral do seu estoque e operações</p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              {loading ? (
                ...
                <>
                  <div className="text-2xl font-bold">{formatCurrency(stats?.totalValor || 0)}</div>
                ...
                <div className="space-y-4">
                  {expiringProducts.map((product) => (
                    ...
                    >
                      ...
                      <Badge variant={getExpiryBadgeVariant(product.diasParaVencer)}>

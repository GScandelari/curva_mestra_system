        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="enable-expiry">Ativar alertas de vencimento</Label>
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting('enable_expiry_alerts', checked)}
                />
              </div>

              {settings.enable_expiry_alerts && (
                <div className="space-y-2">
                  <Label htmlFor="expiry-days">Dias de antecedência para alerta</Label>
                  <Input
                    id="expiry-days"
                    type="number"
                    min="1"
                    ...
                    onChange={(e) =>
                      updateSetting('expiry_warning_days', parseInt(e.target.value) || 30)
                    }
                  />
                  <p className="text-sm text-muted-foreground">
                    Produtos que vencem em até {settings.expiry_warning_days} dias geram alerta
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure alertas para produtos com estoque baixo</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="enable-low-stock">Ativar alertas de estoque baixo</Label>
                  <p className="text-sm text-muted-foreground">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting('enable_low_stock_alerts', checked)}
                />
              </div>

              {settings.enable_low_stock_alerts && (
                <div className="space-y-2">
                  <Label htmlFor="low-stock-threshold">Quantidade mínima (limite padrão)</Label>
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting('low_stock_threshold', parseInt(e.target.value) || 10)
                    }
                  />
                  <p className="text-sm text-muted-foreground">
                    Produtos com menos de {settings.low_stock_threshold} unidades geram alerta
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="enable-requests">Ativar alertas de solicitações</Label>
                  <p className="text-sm text-muted-foreground">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting('enable_request_alerts', checked)}
                />
              </div>
            </CardContent>
          </Card>

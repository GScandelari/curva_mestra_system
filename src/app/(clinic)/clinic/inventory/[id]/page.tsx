    ...
    return (
      <div className="container py-8">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold">{error || 'Produto não encontrado'}</h2>
    ...
    <div className="container py-8">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          <Button variant="outline" size="sm" onClick={() => router.push('/clinic/inventory')}>
            <ArrowLeft className="mr-2 h-4 w-4" />
            Voltar
          </Button>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detalhes e identificação</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground font-mono">{item.codigo_produto}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{item.nome_produto}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground font-mono">{item.lote}</p>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Quantidades e informações financeiras</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <p className="text-sm font-medium">Quantidade Inicial</p>
                  <p className="text-2xl font-bold">{item.quantidade_inicial}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-sm font-medium">Quantidade Disponível</p>
                  <p className="text-2xl font-bold text-primary">{item.quantidade_disponivel}</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {item.quantidade_inicial - item.quantidade_disponivel} unidades
                  </span>
                </div>
              ...
              <div className="pt-2 border-t">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xl font-bold">{formatCurrency(item.valor_unitario)}</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Validade e entrada no sistema</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-semibold">{formatDate(item.dt_validade)}</p>
                  <p className="text-xs text-muted-foreground mt-1">{expiryStatus.text}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{formatDate(item.dt_entrada)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Registro e atualizações</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">{formatDateTime(item.updated_at)}</p>
              </div>

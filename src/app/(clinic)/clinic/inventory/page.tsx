    ...
    <div className="container py-8">
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Gerenciar Estoque</h2>
            <p className="text-muted-foreground">Visualize e gerencie seus produtos e estoques</p>
          </div>
                  ...
                  <TableBody>
                    {filteredInventory.map((item) => (
                      <TableRow
                        ...
                        onClick={() => router.push(`/clinic/inventory/${item.id}`)}
                      >

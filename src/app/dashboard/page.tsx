        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-amber-600 dark:text-amber-400 text-sm mt-2">
              ⚠️ Esta página só deve ser acessada para debug. Usuários com roles configurados são
              ...
              {claims ? (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{claims.active ? 'Sim' : 'Não'}</p>
                  </div>
                </>
              ) : (
                <div className="text-sm text-amber-600 dark:text-amber-400">
                  Nenhuma permissão configurada. Entre em contato com o administrador.
                </div>
              )}
            </CardContent>
          </Card>
